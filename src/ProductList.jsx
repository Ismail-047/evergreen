...
function ProductList({ onHomeClick }) {
    ...
    const totalCartQuantity = useSelector(state => state.cart.items.reduce((sum, i) => sum + (i.quantity || 1), 0));
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>EverGreen</h3>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        {totalCartQuantity > 0 && (
                            <span style={{ position: 'absolute', top: 0, right: 0, background: 'red', color: 'white', borderRadius: '50%', padding: '2px 8px', fontSize: '14px' }}>
                                {totalCartQuantity}
                            </span>
                        )}
                    </div>
